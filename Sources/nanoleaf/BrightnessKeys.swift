...
final class BrightnessKeys {
    ...
    var status: String {
        tap == nil ? "Keyboard shortcuts unavailable. Allow Nanoleaf.app in System Settings > Privacy & Security > Accessibility, then run nanoleaf status." : "Shift + Brightness Up/Down active (5 percentage points). F18/F19: warmer/cooler by 100 K."
    }
